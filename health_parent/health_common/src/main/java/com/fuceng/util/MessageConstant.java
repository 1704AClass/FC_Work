...
public class MessageConstant {
	...
	public static final String QUERY_CHECKITEM_SUCCESS="查询检查组成功";
	public static final String QUERY_CHECKITEM_FAIL="查询检查组失败";
	...
	public static final String ADD_SETMEIL_SUCCESS="新增套餐成功";
	...
	public static final String QUERY_ORDER_SUCCESS="查询预约数据成功";
	public static final String QUERY_ORDER_FAIL="查询预约数据失败";
	...
	public static final String SEND_VALIDATECODE_SUCCSS="验证码发送成功";
	public static final String SELECTED_DATE_CANNOT_ORDER="所选日期不能进行体检预约";
	public static final String ORDER_FULL="预约已满";
	public static final String HAS_ORDERED="已经预约完成，不能重复预约";
	...
	public static final String GETSETMEAL_LIST_SUCCESS="查询套餐列表数据成功";
