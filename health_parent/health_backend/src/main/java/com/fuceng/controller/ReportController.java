...
public class ReportController {
	...
	public Result exportBusinessReport(HttpServletRequest request,HttpServletResponse response) {
		try {
			...
			Integer thisWeekOrderMember = (Integer) result.get("thisWeekOrderMember");
			Integer thisMonthOrderMember = (Integer) result.get("thisMonthOrderMember");
			...
			row = sheet.getRow(8);
			row.getCell(5).setCellValue(thisWeekOrderMember);
			row.getCell(7).setCellValue(thisWeekVisitsNumber);

			row = sheet.getRow(9);
			row.getCell(5).setCellValue(thisMonthOrderMember);
